import { Directive, TemplateRef, Injectable, Component, Renderer2, ElementRef, Input, EventEmitter, Output, ViewChild, NgZone, forwardRef, Inject, ViewEncapsulation, ChangeDetectionStrategy, ChangeDetectorRef, ContentChild, HostListener, HostBinding, ContentChildren, InjectionToken, Attribute, NgModule } from '@angular/core';
